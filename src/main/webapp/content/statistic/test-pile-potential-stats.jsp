                        ...
                        <div class="portlet-body">
                            <div class="row-fluid">
                                  <div class="span12">
                                        ...
                                        <input class="input-append" placeholder="所属区域" style="max-width: 6em" type="text" class="m-wrap" id="area" list="areaList"/>
                                        ...
                                        <button  onclick ="$('.statistic-table').tableExport({type:'excel',fileName:'测试桩(井)电位统计', excelstyles:['border-bottom', 'border-top', 'border-left', 'border-right']});" class="btn blue input-append"><i class="icon-add"></i>导出Excel</button>
                                        <button  onclick ="$('.statistic-table').tableExport({type:'word',fileName:'测试桩(井)电位统计'});" class="btn blue input-append"><i class="icon-add"></i>导出Word</button>
                                   </div>
...
<script>
    ...
    $(function () {
        ...
        handleDatePickers();
        TestPileStats.initForPotential();
    })
    $("#searchMarker").click(function(){
        ...
        var area = $("#area").val();
        TestPileStats.initForPotential(beginDate,endDate,ownerComp,area)
    });
</script>
