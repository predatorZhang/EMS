                ...
                <div class="span12">
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-edit"></i>工单信息编辑</div>
                        </div>
                                ...
                                <form action="" class="form-horizontal" id="submit_form">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <select class="span6 chosen" data-with-diselect="1"
                                                    data-placeholder="选择巡检人员" tabindex="1" name="patrolerId">

                                                <c:forEach items="${users}" var="item">

                                                    <option value="${item.id}"  ${ item.id==model.patrolerId ? 'selected' : '' }>${item.userName}</option>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <textarea class="large m-wrap" rows="3"  name="description" id="description">${model.description}</textarea>
...
<script src="${ctx}/s/app/task/task-info-edit.js"></script>
