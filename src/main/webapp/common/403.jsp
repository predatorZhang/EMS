...
<div id="targetContentDiv">
    <div class="container">
        ...
        <ul>
            <li><a class="btn btn-primary" href="javascript:void(0);" onclick="history.back()"><spring:message
                    code="core.403.back" text="返回"/></a></li>
            <li><a class="btn" href="${ctx}/j_spring_security_logout"><spring:message code="core.403.logout"
                                                                                      text="注销"/></a></li>
        </ul>
    </div>
</div>
