                        ...
                        <div class="portlet-body">
                            <div class="row-fluid">
                                  <div class="span12">
                                            ...
                                            <button  onclick ="$('.statistic-table').tableExport({type:'excel',fileName:'测试桩(井)维护处理统计', excelstyles:['border-bottom', 'border-top', 'border-left', 'border-right']});" class="btn blue input-append"><i class="icon-add"></i>导出Excel</button>
                                            <button  onclick ="$('.statistic-table').tableExport({type:'word',fileName:'测试桩(井)维护处理统计'});" class="btn blue input-append"><i class="icon-add"></i>导出Word</button>
                                        </div>
...
<script>
    ...
    $("#searchMarker").click(function(){
        ...
        var area = $("#area").val();
        TestPileStats.initForMaintain(beginDate,endDate,ownerComp,area)
    });
</script>
