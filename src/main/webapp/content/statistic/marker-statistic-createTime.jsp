                        ...
                        <div class="portlet-body">
                            <div class="row-fluid">
                                  <div class="span12">
                                          ...
                                          <button  onclick ="$('.statistic-table').tableExport({type:'excel',fileName:'按照建造时间统计电子标识器', excelstyles:['border-bottom', 'border-top', 'border-left', 'border-right']});" class="btn blue input-append"><i class="icon-add"></i>导出Excel</button>
                                          <button  onclick ="$('.statistic-table').tableExport({type:'word',fileName:'按照建造时间统计电子标识器'});" class="btn blue input-append"><i class="icon-add"></i>导出Word</button>
                                        </div>
