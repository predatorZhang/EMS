...
<div id="targetContentDiv">
    <div class="container">
        ...
        <ul>
            ...
            <li><a class="btn" href="javascript:void(0);" onclick="$('#output').show();$('#targetContentDiv').hide();">显示详情</a>
            </li>
        </ul>
    </div>
</div>
<div id="output" style="display:none">
    <div style="text-align:center;" class="container">
        <a class="btn btn-info container" href="javascript:void(0);"
           onclick="$('#output').hide();$('#targetContentDiv').show();">返回</a>
    </div>
	  <pre>
<%=requestInfo%>
<hr>
